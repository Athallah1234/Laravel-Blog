...
@section('content')
  ...
  <div class="content">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
      <h4>Kategori</h4>
      <a href="{{ route('dashboard.categories.create') }}" class="btn btn-primary">Tambah Kategori</a>
    </div>
          ...
          <tbody>
            @foreach($categories as $category)
              <tr>
                ...
                <td>{{ $category->slug }}</td>
                <td>
                  <a href="{{ route('dashboard.categories.show', $category) }}" class="btn btn-info btn-sm">Detail</a>
                  <a href="{{ route('dashboard.categories.edit', $category) }}" class="btn btn-warning btn-sm">Edit</a>
