...
@push('styles')
  <style>
    ...
    /* Hero Section */
    .hero {
      background: linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.4)), url('https://source.unsplash.com/1600x400/?tag,blog') no-repeat center center;
...
@section('content')
  <!-- Hero Section -->
  <section class="hero">
    <h1 class="display-4 fw-bold">Tag: {{ $tag }}</h1>
  </section>
            ...
            <div class="col-md-6">
              <div class="card shadow-sm">
                ...
                <div class="card-body">
                  ...
                  <p class="text-muted mb-1">{{ $article->created_at->format('d M Y') }} | Kategori: {{ $article->category->name }}</p>
